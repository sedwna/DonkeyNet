    ...
    try {
        ...
        try {
            ...
            try {
                ...
                $graphics.DrawString($Title, $titleFont, $whiteBrush, (New-Object System.Drawing.RectangleF(230, 94, 880, 56)), $format)
                $graphics.DrawString($Ping, $pingFont, $mutedBrush, (New-Object System.Drawing.RectangleF(230, 154, 880, 48)), $format)
                $graphics.DrawString($Description, $descriptionFont, $whiteBrush, (New-Object System.Drawing.RectangleF(230, 211, 880, 60)), $format)
            }
            finally {
                $format.Dispose()
                $mutedBrush.Dispose()
...
New-StatusImage -FileName 'status-offline.png' -Accent '#EF4444' `
    -Title 'اینترنت خود خر است.' -Ping 'پینگ: قطع' `
